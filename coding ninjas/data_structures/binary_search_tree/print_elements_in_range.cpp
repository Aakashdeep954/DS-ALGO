...
void print_elements_in_range(binary_tree<int> *root, int k_1, int k_2)
{
    if (root == NULL)
    {
        return;
    ...
    if (root->data > k_2)
    {
        print_elements_in_range(root->left, k_1, k_2);
    }
    else if (root->data < k_1)
    {
        print_elements_in_range(root->right, k_1, k_2);
    }
    else
    {
        print_elements_in_range(root->left, k_1, k_2);
...
void solve()
{
    ...
    int k_1, k_2;
    cin >> k_1 >> k_2;
    print_elements_in_range(root, k_1, k_2);
}
int main()
{
