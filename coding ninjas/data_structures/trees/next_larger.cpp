...
tree_node<int> *next_larger(tree_node<int> *root, int n)
{
    ...
    {
        tree_node<int> *child_ans = next_larger(root->children[i], n);
        if (ans != NULL && child_ans != NULL)
        {
            if (ans->data > child_ans->data)
            {
                ans = child_ans;
            }
        }
        else if (ans == NULL && child_ans != NULL)
        {
            ans = child_ans;
        }
    }
...
void solve()
{
    ...
    int n;
    cin >> n;
    tree_node<int> *ans = next_larger(root, n);
    if (ans != NULL)
    {
        cout << ans->data << endl;
    }
