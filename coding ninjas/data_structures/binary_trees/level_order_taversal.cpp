...
binary_tree_node<int> *take_input()
{
    ...
    {
        binary_tree_node<int> *current_node = pending_nodes.front();
        pending_nodes.pop();
        int left_child, right_child;
        cin >> left_child;
        if (left_child != -1)
        {
            binary_tree_node<int> *left_node = new binary_tree_node<int>(left_child);
        ...
        if (right_child != -1)
        {
            binary_tree_node<int> *right_node = new binary_tree_node<int>(right_child);
...
void solve()
{
    binary_tree_node<int> *root = take_input();
    level_order(root);
}
int main()
{
